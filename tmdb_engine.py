...
def get_homepage_content():
    """Fetches high-quality home rows safely with strict 1080p branding"""
    ...
    for m in b_data:
        ...
        img = f"https://image.tmdb.org/t/p/w1280{backdrop}" if backdrop else "https://images.unsplash.com/photo-1594909122845-11baa439b7bf?q=80&w=1280"
        bollywood.append({
            "id": m.get('id'),
